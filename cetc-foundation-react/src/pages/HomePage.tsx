        ...
        <div className="hero-inner">
          <div className="hero-left">
            <div className="hero-eyebrow">
              <span>✦</span> Government Recognized · ISO 9001:2015 Certified
            </div>
            <h1>
            ...
            <div className="hero-btns">
              <Link to="/courses" className="btn btn-gold btn-lg" id="hero-cta-courses">
                📚 Browse Courses
              </Link>
              <Link to="/verify" className="btn btn-outline btn-lg" id="hero-cta-verify">
                🔍 Verify Certificate
              </Link>
            </div>
          </div>
      ...
      <section className="section" style={{ background: 'var(--warm)' }} id="why-cetcf">
        <div className="wrap">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px', marginTop: '40px' }}>
            {[
              { icon: '🏛️', title: 'Government Recognized', desc: 'Section 8 Company registered under the Ministry of Corporate Affairs, Government of India.' },
              { icon: '🌐', title: '100% Online Exams', desc: 'Take your certification exam from anywhere. No travel needed. Results in real-time.' },
              { icon: '📱', title: 'Digital Certificates', desc: 'QR-verified digital certificates issued instantly. Physical copy couriered within 10-15 days.' },
              { icon: '💰', title: 'Affordable Fees', desc: 'Starting at just ₹1,000. Quality certification shouldn\'t cost a fortune.' },
              { icon: '🔄', title: 'RPL Pathway', desc: 'Already skilled? Skip the course — directly take the exam and get certified.' },
              { icon: '🤝', title: 'Partner Network', desc: 'Join as an Authorized Assessment Center (AAC) and earn commissions per certified candidate.' },
            ].map((item, i) => (
